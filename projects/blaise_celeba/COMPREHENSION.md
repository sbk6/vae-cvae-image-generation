...
| Arret anticipe | patience 10, `min_delta=1.0`, apres epoch 20 | Si la loss de validation ne bat pas le meilleur score d'au moins 1.0 pendant 10 epochs consecutives apres l'epoch 20, on arrete. Cela evite d'arreter pendant le warmup KL, quand beta augmente encore et que la loss change de nature. |
